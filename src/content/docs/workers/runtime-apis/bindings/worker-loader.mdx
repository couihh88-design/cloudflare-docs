...
Dynamic Workers don't have their own persistent storage—they run user-provided code that exists only for the duration of execution. If your Dynamic Worker needs to store data between runs, you'll need to pass it access to storage from elsewhere.

Choose your approach based on what you're passing:
